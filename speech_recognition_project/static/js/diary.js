...
function loadPopupDiaries() {
    ...
    diaries.forEach(diary => {
        ...
        const sections = tempDiv.querySelectorAll('.diary-section');
        let diaryContent = '';
        
        sections.forEach(section => {
            const title = section.querySelector('div:first-child')?.textContent || '';
            const content = section.querySelector('div:nth-child(2)')?.textContent || '';
            diaryContent += `
                <div class="diary-section-preview">
